...
public class IndexController {
    ...
    public void newShape() {
        if (this.shapeToDraw.equals("Circle")) {
            ...
            //drawCircle(x, y, radius, this.colorToDraw);
            ...
            //this.drawRectangle(x, y, width, height, this.colorToDraw);
        }
        this.launchCalc();
    }
    ...
    public void drawColorShape(List<ColorShape> colorShapeList) {
        ...
        for (ColorShape colorShape : colorShapeList) {
            Circle circle = new Circle((float) (counter * 800) / colorShapeList.size() + (float) 400 / colorShapeList.size(), 720, 25);
            circle.setStrokeType(StrokeType.INSIDE);
            circle.setStroke(Color.BLACK);
